// Rechtstexte, übernommen von fortis-inkasso.de (Stand Juli 2026)
...
export const impressum: LegalSection[] = [
  {
    ...
    "p": [
      ...
      "Die Fortis Inkasso GmbH & Co. KG nimmt nicht an einem Streitbeilegungsverfahren im Sinne des VSBG teil. Es besteht diesbezüglich keine gesetzliche Verpflichtung."
    ]
  }
];
...
export const agb: LegalSection[] = [
  {
    "h": "ALLGEMEINE GESCHÄFTSBEDINGUNGEN der Fortis Inkasso GmbH & Co. KG",
    "p": []
  },
  {
    "h": "§ 2 Zugang; Standard-Services",
    "p": [
      "Der Auftraggeber ist – vorbehaltlich abweichender Individualvereinbarungen – berechtigt, Forderungen und zugehörige Rechnungs- bzw. Anspruchsunterlagen über das Serviceportal in beliebiger Anzahl einzureichen und im Rahmen des außergerichtlichen Forderungsmanagements bearbeiten zu lassen (Standard-Services).",
      "Fortis ist berechtigt, den Zugang zum Serviceportal und/oder einzelne Funktionalitäten von der Erfüllung von Mitwirkungspflichten, der Hinterlegung vollständiger Stammdaten sowie der fristgerechten Zahlung fälliger Entgelte abhängig zu machen.",
      "Fortis schuldet die Bereitstellung des Serviceportals in seiner jeweils aktuellen Fassung im Rahmen der technischen und betrieblichen Möglichkeiten. Ein Anspruch auf jederzeitige ununterbrochene Verfügbarkeit besteht nicht; Fortis ist zu Wartungsfenstern sowie technisch bedingten Unterbrechungen berechtigt.",
      "Zugangsdaten sind geheim zu halten und vor dem Zugriff Dritter zu schützen. Nutzungen unter ordnungsgemäßer Verwendung der Zugangsdaten gelten im Verhältnis zwischen Fortis und Auftraggeber als vom Auftraggeber veranlasst, soweit nicht der Auftraggeber nachweist, dass ihn kein Verschulden trifft."
    ]
  },
  {
    "h": "B. Inkassoauftrag / Leistungsdurchführung",
    "p": []
  },
  {
    "h": "§ 3 Auftragserteilung und Leistungsgegenstand",
    "p": [
      "Die Auftragserteilung erfolgt durch die Übergabe/Übermittlung der Schuldner- und Forderungsdaten; sie ist nicht zwingend bereits nur durch das Ausfüllen eines Kontaktformulars abgeschlossen. Alle Angebote von Fortis sind unverbindlich; insbesondere Zeitangaben (Ausführungsfristen usw.) sind unverbindlich, es sei denn, ihre Verbindlichkeit wird ausdrücklich zugesagt.",
      "Ohne gesonderten und vergütungspflichtigen Auftrag prüft Fortis Einwendungen und Einreden gegen die ihr zur Einziehung übertragene Forderung nicht.",
      "Die Vergütung von Fortis richtet sich, soweit gesetzlich einschlägig, nach den Vorschriften des Rechtsdienstleistungsgesetzes (RDG) und des Rechtsanwaltsvergütungsgesetzes (RVG). Für die Erstattungsfähigkeit gegenüber dem Schuldner gelten die gesetzlichen Vorschriften, insbesondere § 13e RDG; bei einer kombinierten Beauftragung von Inkassodienstleister und Rechtsanwalt gilt zusätzlich § 13f RDG. Soweit Fortis Kosten, Gebühren, Auslagen oder Nebenforderungen gegenüber dem Schuldner geltend macht, erfolgt dies nur im gesetzlich zulässigen Umfang.",
      "Fremdkosten und Auslagen, insbesondere Gerichts- und Gerichtsvollzieherkosten, Registerauskünfte, Meldeamtsanfragen, Detektei- und Behördenkosten, Zustellungen, Übersetzungen, Auslandsinkasso-Kosten sowie Kosten beauftragter Rechtsanwälte/Partnerkanzleien, trägt der Auftraggeber, soweit diese nicht vom Schuldner realisiert werden können oder von Fortis verauslagt wurden. Fortis ist berechtigt, für entstandene oder voraussichtlich entstehende Fremdkosten und Auslagen vor Durchführung der jeweiligen Maßnahme einen angemessenen Vorschuss bzw. die sofortige Bereitstellung der konkret angeforderten Beträge zu verlangen.",
  ...
  },
  {
    ...
    "p": [
      ...
      "Bei vorzeitiger Beendigung des Auftrags vor Eintritt eines Erfolgs fällt für die bis dahin erbrachte außergerichtliche Tätigkeit keine erfolgsabhängige Vergütung an. Erfolgen nach Beendigung des Auftrags jedoch noch Zahlungen oder sonstige wirtschaftliche Realisierungen aufgrund einer während der Vertragslaufzeit von Fortis veranlassten oder abgeschlossenen Zahlungs-, Ratenzahlungs- oder Vergleichsvereinbarung oder aufgrund sonstiger von Fortis veranlasster Maßnahmen, bleibt die erfolgsabhängige Vergütung nach den vorstehenden Absätzen geschuldet.",
      "Ein Erfolgshonorar wird nicht vereinbart, soweit sich die Inkassodienstleistung auf eine Forderung bezieht, die der Pfändung nicht unterworfen ist.",
      "Hinweis: Gegen den Schuldner sind Inkassokosten nur bis zur Höhe der einem Rechtsanwalt nach dem RVG zustehenden Vergütung erstattungsfähig."
    ]
  },
  {
  ...
  {
    "h": "§ 6 Verrechnungsfolge; Sammelabrechnung; Aufrechnung; Abtretung",
    "p": [
      "Soweit der Schuldner mehrere Forderungen schuldet, richtet sich die Tilgung der einzelnen Forderungen zunächst nach einer wirksamen Tilgungsbestimmung des Schuldners und im Übrigen nach den gesetzlichen Vorschriften. Innerhalb der jeweils betroffenen Forderung werden eingehende Zahlungen – soweit gesetzlich zulässig – zuerst auf Kosten, dann auf Zinsen und zuletzt auf die Hauptforderung angerechnet.",
      ...
      "Soweit keine zwingenden gesetzlichen Vorgaben, wirksamen Tilgungsbestimmungen des Schuldners oder vorrangigen Rechte Dritter entgegenstehen, ist Fortis berechtigt, die buchhalterische Zuordnung und Verrechnung von Zahlungseingängen auf einzelne Positionen des Mandantenkontos nach billigem Ermessen vorzunehmen.",
      "Die jeweilige Sammelabrechnung, Einzelabrechnung oder sonstige Verrechnungserklärung in Textform gilt zugleich als Aufrechnungserklärung. Ein Auskehrungsanspruch des Auftraggebers entsteht erst, soweit und sobald nach vollständiger Erfassung und Verrechnung sämtlicher fälligen Ansprüche von Fortis ein positiver Saldo zugunsten des Auftraggebers verbleibt und keine berechtigten Einbehalte wegen Rückbelastungs-, Rückforderungs-, Widerspruchs- oder Klärungsfristen, laufender Fremdkosten oder sonstiger Gebühren-/Kostenrisiken mehr bestehen.",
      "Soweit Beträge nach Abtretung, Aufrechnung, Verrechnung oder aufgrund eines Zurückbehaltungsrechts Fortis zustehen, handelt es sich nicht um an den Auftraggeber auszukehrendes Fremdgeld. Im Übrigen werden Fremdgelder nach den gesetzlichen Vorgaben behandelt. Fremdgeldbeträge werden nicht verzinst.",
      "Je nachdem, mit welchem Zahlungsmittel eine Zahlung erfolgt, kann Fortis die Abrechnung eines darin enthaltenen Fremdgeldanteils bis zum Ablauf üblicher Rückbelastungs-, Chargeback- oder Widerspruchsfristen zurückstellen.",
  ...
  {
    "h": "§ 7 Beendigung einzelner Inkassoaufträge; Zurückbehaltungsrecht",
    "p": [
      "Jeder Inkassoauftrag kann vom Auftraggeber jederzeit in Textform gekündigt werden. Bei Kündigung oder sonstiger Beendigung bleiben bis dahin fällige erfolgsabhängige Vergütungen nach § 4 (einschließlich später nach § 4 Abs. 8 fällig werdender Vergütungsbestandteile), verauslagte oder angeforderte Fremdkosten, Gerichtskosten, Kosten gerichtlicher Maßnahmen, Kosten der Zwangsvollstreckung, Kosten beauftragter Rechtsanwälte/Partnerkanzleien sowie sonstige Auslagen unberührt.",
      "Die Kündigung bzw. sonstige Beendigung bedarf der Textform (E-Mail genügt), soweit nicht zwingend eine strengere Form vorgeschrieben ist.",
      "Hinsichtlich der Vollstreckungsunterlagen einschließlich des Vollstreckungstitels besteht ein Zurückbehaltungsrecht bis zur Bezahlung der angefallenen und in Rechnung gestellten Kosten durch den Auftraggeber.",
  ...
  {
    "h": "§ 10 Gerichtsstand / Anwendbares Recht",
    "p": [
...
export const datenschutz: LegalSection[] = [
  ...
  },
  {
    ...
    "p": [
      ...
      "40235 Düsseldorf",
      "Germany",
      "E-Mail: info@fortis-inkasso.de",
      "Represented by its general partner Fortis Verwaltungs GmbH."
    ]
  },
  {
    "h": "Übersicht der Verarbeitungen",
    "p": [
  ...
  {
    "h": "Kategorien betroffener Personen",
    "p": [
      "Kunden.",
      "Interessenten.",
  ...
  {
    "h": "Im Rahmen der Geschäftstätigkeit eingesetzte Anbieter und Services",
    "p": [
      "Im Rahmen unserer Geschäftstätigkeit nutzen wir unter Beachtung der gesetzlichen Vorgaben zusätzliche Dienste, Plattformen, Schnittstellen oder Plug-ins von Drittanbietern (kurz „Dienste“). Deren Nutzung beruht auf unseren Interessen an einer ordnungsgemäßen, rechtmäßigen und wirtschaftlichen Führung unseres Geschäftsbetriebes und unserer Organisationsmaßnahmen.",
  ...
  {
    "h": "Bereitstellung des Onlineangebotes und Webhosting",
    "p": [
  ...
  {
    "h": "Blogs und Publikationsmedien",
    "p": [
  ...
  {
    "h": "Kontakt- und Anfragenverwaltung",
    "p": [
  ...
  {
    "h": "Werbliche Kommunikation via E-Mail, Post, Fax oder Telefon",
    "p": [
  ...
  {
    "h": "Webanalyse, Monitoring und Optimierung",
    "p": [
...
export const widerruf: LegalSection[] = [
  {
    "h": "Widerrufsbelehrung  der Fortis Inkasso GmbH & Co. KG",
    "p": [
  ...
  },
  {
    ...
    "p": [
      ...
      "Der Nutzer verlangt, dass wir unmittelbar nach der Registrierung (vor Ablauf einer gesetzlichen Widerrufsfrist) mit der Erbringung der Dienstleistungen beginnen.",
      "Der Nutzer nimmt zur Kenntnis, dass sein gesetzliches Widerrufsrecht als Verbraucher nach vollständiger Erbringung der Dienstleistung erlöschen kann (und/oder er gegebenenfalls einen anteiligen Betrag zahlen muss, wenn er nach Beginn der Erbringung widerruft).",
